...
<h3 id="attributes-card-header" class="card-header"><?php echo TEXT_PRODUCT_OPTIONS; ?></h3>
...
<?php if(mb_strpos($options_html_id[$i],'txt-attrib-')!==false){ ?>
<div id="attributeOptions<?php echo $options_html_id[$i]; ?>-card" class="wrapperAttribsOptions">
<div id="attributeOptions<?php echo $options_html_id[$i]; ?>-card-body" class="mb-3">
<?php } else { 
/*
