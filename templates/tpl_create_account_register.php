...
<div class="centerColumn" id="registerDefault">
	...
	<div class="row" style="margin-top: 30px;margin-bottom: 20px;">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><img src="/images/labels_2a.webp"></div>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><img src="/images/labels_2b.webp"></div>
	</div>	
<?php
...
echo recaptcha_get_html(false); ?>

    <div class="buttonRow text-center"><br><?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_REGISTER_ALT); ?></div>
<?php
echo '</form>';
?>
</div>
