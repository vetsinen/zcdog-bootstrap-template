...
elseif($header_style=='header_style_5') {
	...
	$nav_container_class = "container-fluid";
	$navbar_class = "navbar navbar-color-white";
 ...
 * PRODUCTS LISTING
 *=======================================*/
if(($current_page_base == 'index' && ($_GET['cPath'] != '')) || ($current_page_base == 'index' and ($_GET['manufacturers_id'] != '')) || in_array($current_page_base, array('specials','featured_products','products_new','products_all','advanced_search_result','best_sellers','page_not_found' ))){
...
if($randprod_style=='default') {
	...
	$randproduct_container_id = 'gridRandom';
}
...
if($fproducts_display_style=='default') {
	...
	$fproduct_container_id = 'gridFeatured';
}
...
if($sproducts_display_style=='default') {
	...
	$sproduct_container_id = 'gridSpecials';
}
...
if($bproducts_display_style=='default') {
	...
	$bproduct_container_id = 'gridBestSeller';
}
...
a{color: <?php echo $theme_color; ?>;text-decoration: none;}
a:hover, a:focus{color: <?php echo $theme_color; ?>;text-decoration: underline;}
...
#header.header-layout-03 .stuck-nav {background-color: <?php echo $theme_color; ?>;}
...
.search a:hover .icon, #search-dropdown .input-outer button:hover, #search-dropdown-menu .input-outer button:hover,  #search-dropdown-fix .input-outer button:hover {color: <?php echo $theme_color; ?>;}
...
.subscribe-box #mc_embed_signup input:focus, .subscribe-box #mc_embd_signup input:focus{border-color: <?php echo $theme_color; ?>;}
...
.navbar-vertical #mainMenu .navbar-nav > li > a:before, .navbar-vertical #leftMenu .navbar-nav > li > a:before {background-color: <?php echo $theme_color; ?>;}
...
.megamenu__subtitle span:first-child,#mainMenu .mn1 li > ul,#leftMenu .mn1 li > ul {border-bottom: 2px solid <?php echo $theme_color; ?> !important;}
.megamenu__subtitle:hover span:first-child, .megamenu > li:hover .megamenu__subtitle span {color: <?php echo $theme_color; ?>;}
.navbar.navbar-vertical #mainMenu .navbar-nav > li > a .icon, .navbar.navbar-vertical #mainMenu .navbar-nav > li > a:hover, .navbar.navbar-vertical #leftMenu .navbar-nav > li > a .icon, .navbar.navbar-vertical #leftMenu .navbar-nav > li > a:hover {color: <?php echo $theme_color; ?>;}
.navbar.navbar-vertical #mainMenu .navbar-nav > li:hover .dropdown-menu:before, .navbar.navbar-vertical #leftMenu .navbar-nav > li:hover .dropdown-menu:before {background-color: <?php echo $theme_color; ?>;}
.cart .dropdown-menu.slide-from-top .cart__item__info__title h2 a {color: <?php echo $theme_color; ?>;}
.cart .dropdown-menu.slide-from-top .cart__item__edit .icon, .cart .dropdown-menu.slide-from-top .cart__item__delete .icon {color: <?php echo $theme_color; ?>; font-size:27px;}
...
#search-dropdown .search__close .icon:hover, #search-dropdown-menu .search__close .icon:hover, #search-dropdown-fix .search__close .icon:hover {color: <?php echo $theme_color; ?>;}
...
#header .navbar, #header .settings {background-color: <?php echo $theme_color; ?>;}
}
/* Theme Color Ends*/
<?php if($this_is_home_page) { ?>
...
.navbar-vertical.fill-bg #mainMenu .navbar-nav > li > a::before, .navbar-vertical.fill-bg #leftMenu .navbar-nav > li > a::before{background-color:<?php echo $theme_color; ?>;}
.navbar.navbar-vertical.fill-bg #mainMenu .navbar-nav > li > a, .navbar.navbar-vertical.fill-bg #leftMenu .navbar-nav > li > a {background: <?php echo $theme_color; ?> none repeat scroll 0 0;border-bottom:1px solid rgba(250, 250, 250, 0.2);color: #fff;}
/*** Menu SHOP start ***/
@media (min-width: 1024px) {
#mainMenu .mn1 li > ul li > ul, #leftMenu .mn1 li > ul li > ul {border-top: 2px solid <?php echo $theme_color; ?>;}
#mainMenu ul ul li.submenu::before, #leftMenu ul ul li.submenu::before {border-color: transparent transparent transparent <?php echo $theme_color; ?>;}
#mainMenu ul ul li.submenu:hover::before, #leftMenu ul ul li.submenu:hover::before {border-color: <?php echo $theme_color; ?> transparent transparent transparent;}
}
/*** Menu SHOP end ***/
/*** fix user menu start ***/
@media (max-width: 1024px) {
#header.header-layout-03 .fixedbar .fix-user-menu .account {background-color: <?php echo $theme_color; ?>;}
}
/*** fix user menu end ***/
